...
async function createRoom() {
  if (!supabase) { localStorage.setItem(`state:${room}`, JSON.stringify(demoState)); return; }
  await supabase.from('game_rooms').upsert(demoState, { onConflict: 'room_code' });
}
